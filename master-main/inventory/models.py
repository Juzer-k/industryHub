...
from task.models import PurchaseOrder
...
class Inventory(models.Model):
    ...
    item_rack = models.ForeignKey(Rack,on_delete=models.CASCADE,null=True, blank=True)
    ...
    racks = models.CharField(max_length=200, null=True, blank=True)
    product_or_service = models.CharField(max_length=200, choices=PRODUCT_SERVICE, default="Product", null=True, blank=True)
    price = models.CharField(max_length=200, null=True, blank=True)
    unit_of_measurement =  models.CharField(max_length=300, choices=ITEM_UNIT, default="Kg", null=True, blank=True)
